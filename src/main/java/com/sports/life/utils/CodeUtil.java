...
public class CodeUtil {
    private static final String DEPT_TPYE="HD";

    private static final String ORDER_ID="DD";
     ...
     * @return
     */
    public static String orderCode(String oriStr,int len,String alexin){
        return ORDER_ID+padRight(oriStr, len, alexin);
    }
}
